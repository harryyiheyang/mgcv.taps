...
fit4=taps_score_test(b,test.component=1,method="imhof")
fit5=taps_score_test(b,test.component=1,method="hall")
fit6=taps_score_test(b,test.component=1,method="wood")
