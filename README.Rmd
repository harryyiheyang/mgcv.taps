...
```
This is evidence that median GAM can be used to make the fit more robust. Currently, score tests have been extended to partial exponential family models, including `cox.ph`, `ocat`, `nb`, `tw`, `betar`, `scat`, and `qgam`. The results are as follows:
