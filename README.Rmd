...
When the response follows the exponential family of distributions, quantile GAM (`qgam`) can also be incorporated with mgcv.taps, whose usage is slight different from `gam`:
